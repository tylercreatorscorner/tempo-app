/**
 * Permission guard for the affiliates section.
 *
...
export default async function AffiliatesLayout({ children }: { children: React.ReactNode }) {
  await requireScreen('affiliates');
  return <>{children}</>;
}
