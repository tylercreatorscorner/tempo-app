        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50/50">
              <tr>
                <th className="px-5 py-3 text-left text-xs font-medium text-gray-500">Creator</th>
                <th className="px-5 py-3 text-left text-xs font-medium text-gray-500">Retainer</th>
                <th className="px-5 py-3 text-left text-xs font-medium text-gray-500">Status</th>
                <th className="px-5 py-3 text-left text-xs font-medium text-gray-500">Start Date</th>
                <th className="px-5 py-3 text-left text-xs font-medium text-gray-500">Notes</th>
              ...
              {filtered.map((entry) => (
                <tr key={entry.id} className="hover:bg-gray-50/50 transition-colors">
                  <td className="px-5 py-3">
                    <div>
                      <p className="font-medium text-[#1A1B3A]">@{entry.creator_handle}</p>
                      {entry.creator_name && (
                        <p className="text-xs text-gray-400">{entry.creator_name}</p>
                      )}
                    </div>
                  </td>
      ...
      {editingId && (
        <div className="px-5 py-4 border-t border-gray-100 bg-gray-50/50">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-bold text-[#1A1B3A]">Edit Creator</h4>
            <button onClick={() => setEditingId(null)} className="p-1 rounded hover:bg-gray-200">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">Retainer ($)</label>
              <input
                type="number"
