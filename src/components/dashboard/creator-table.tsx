  ...
  return (
    <div className="rounded-2xl overflow-hidden bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] shadow-[0_4px_24px_rgba(0,0,0,0.2)]">
      <div className="px-6 py-4 border-b border-white/[0.06]">
        <h3 className="text-lg font-bold tracking-tight">Top Creators</h3>
      ...
      <div className="overflow-x-auto max-h-[600px] overflow-y-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {creators.length === 0 && (
              <tr><td colSpan={6} className="px-4 py-12 text-center text-muted-foreground/50">No creator data</td></tr>
            )}
          </tbody>
        </table>
      </div>
